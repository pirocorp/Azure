- [Exercise: Route custom events to web endpoint by using Azure CLI](#exercise-route-custom-events-to-web-endpoint-by-using-azure-cli)
  ...
  - [Enable an Event Grid resource provider](#enable-an-event-grid-resource-provider)
  - [Create a custom topic](#create-a-custom-topic)
  - [Create a message endpoint](#create-a-message-endpoint)
  - [Subscribe to a custom topic](#subscribe-to-a-custom-topic)
  - [Validating endpoint](#validating-endpoint)
  - [Send an event to your custom topic](#send-an-event-to-your-custom-topic)
    - [Retrieve URL and key for the custom topic](#retrieve-url-and-key-for-the-custom-topic)
    - [Create event data to send](#create-event-data-to-send)
    - [Use Invoke-WebRequest/curl to send the event to the topic](#use-invoke-webrequestcurl-to-send-the-event-to-the-topic)
