...
Go to the repository and make a change directly in the master branch. The pipeline should be triggered just after the commit. Monitor its execution. Once finished, check the end result.
