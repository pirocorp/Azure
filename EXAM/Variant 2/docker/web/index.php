...
<?php
	...
	$connectionInfo = array("UID" => "examsa", "pwd" => "ExamPassword2022", "Database" => "sqldb", "LoginTimeout" => 30, "Encrypt" => 1, "TrustServerCertificate" => 0);
	$serverName = "tcp:zrzsqlsrv.database.windows.net,1433";
